...
class WGAN_GP(object):
    def __init__(self, args):
        ...
        self.d_optimizer = optim.Adam(self.D.parameters(), lr = self.learning_rate, batas = (self.b1, self.b2))
        self.g_optimizer = optim.Adam(self.G.parameters(), lr = self.learning_rate, batas = (self.b1, self.b2))
    ...
    def train(self, train_loader):
        ...
        for g_iter in range(self.generator_iters):
            ...
            if (g_iter) % SAVE_PER_TIMES == 0:
                ...
                utils.save_image(grid, 'training_result_images/img_generator_iter_{}.png'.format(str(g_iter).zfill(3)))
    ...
    def generator_latent_walk(self, number):
